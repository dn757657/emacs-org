...
(custom-set-variables
 ...
 '(package-selected-packages
   '(citar-org gnus-icalendar forge evil-magit magit counsel-projectile projectile which-key visual-fill-column vertico use-package shrink-path rainbow-delimiters pass ox-pandoc org-roam-bibtex org-bullets latex-preview-pane ivy-rich ivy-bibtex hydra htmlize helpful helm-bibtex gnu-elpa-keyring-update general flyspell-correct-ivy evil-collection doom-themes counsel command-log-mode citar-embark avy auctex)))
(custom-set-faces
